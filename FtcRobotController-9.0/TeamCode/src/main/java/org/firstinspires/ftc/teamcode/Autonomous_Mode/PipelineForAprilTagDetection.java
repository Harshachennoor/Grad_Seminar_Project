// This file is a support pipeline for the OPENCV
...
public class PipelineForAprilTagDetection extends OpenCvPipeline
{
    ...
    public PipelineForAprilTagDetection(double tagsize, double fx, double fy, double cx, double cy)
    {
